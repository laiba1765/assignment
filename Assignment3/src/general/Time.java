...
//i am making an assumption that the time lies in 12 hours format not in 24 hours format so 13 is considered as incorrect
	...
	public void checkDisplay() {
		if (checkHours() == true)
			JOptionPane.showMessageDialog(null,"---------Hours  correct","CHECKER",JOptionPane.WARNING_MESSAGE);
		else
			JOptionPane.showMessageDialog(null,"---------Hours  incorrect","CHECKER",JOptionPane.WARNING_MESSAGE);
		if (checkMins() == true)
			JOptionPane.showMessageDialog(null,"---------Minutes  correct","CHECKER",JOptionPane.WARNING_MESSAGE);
		else
			JOptionPane.showMessageDialog(null,"------Minutes  incorrect","CHECKER",JOptionPane.WARNING_MESSAGE);
		if (checkPeriod() == true)
